...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-W3lOS0vm.mjs");
...
var manifest = {
	"20295c5b6fadfbee69785044cafa78a9852dbc84dbf2ffac78d3da81726cdd04": {
		functionName: "getPlayStreamFn_createServerFn_handler",
		importer: () => import("./functions-Dzq-FW57.mjs")
	},
	"80f5de3fad1910b6a1e161673474cdb89f70a0ff55da87b6e673662fcedf2a54": {
		functionName: "resolveVideosFn_createServerFn_handler",
		importer: () => import("./functions-Dzq-FW57.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CgvhciBf.mjs").then((n) => n.t),
